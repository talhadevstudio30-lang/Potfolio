                    ...
                    <div className='h-auto w-auto mt-4 sm:ml-4.5 text-black'>
                        ...
                        <div className="home-page-title-skill-container pl-3.5 text-start">
                            <h3 className="text-xl md:text-2xl tracking-tight text-gray-800">
                                ...
                                <span className="relative mt-1.5 ml-1 inline-block px-3 py-1.5 rounded-2xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 animate-text-shimmer border-2 border-blue-400 shadow-lg  hover:shadow-blue-400/50 transition text-center duration-200 mr-6">
                                    Frontend Developer
                                    {/* Glow Effect */}
