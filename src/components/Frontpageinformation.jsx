            ...
            <div className='front-page-container h-screen grid justify-center items-center'>
                <div className='grid justify-center items-center md:flex md:justify-center md:items-center h-auto  '>
                    ...
                    <div className='h-auto w-auto mt-4 sm:ml-4.5 text-black' data-aos="zoom-in" data-aos-delay="300">
                        ...
                        <div className="home-page-title-skill-container pl-2.5 text-start">
                            <h3 className="text-xl md:text-2xl tracking-tight text-gray-800">
                                <span className='mt-1 ml-1.5'>And I'm a{" "}</span>
                                <span className="relative mt-1 ml-0.5 inline-block px-3 py-1.5 rounded-2xl font-medium text-transparent bg-clip-text bg-gradient-to-r  from-cyan-400 via-blue-500 to-purple-600 animate-text-shimmer border-2 border-blue-300 shadow-lg hover:shadow-blue-400/50 transition text-center duration-200 mr-6">
                                    Frontend Developer
                                    {/* Glow Effect */}
